...
The **Administrative Data Research Facility** (ADRF) is a secure platform provided by the Coleridge Initiative for researchers to safely access and analyze sensitive administrative data from government agencies. It offers a secure computing environment with tools for analysis, visualization, and data integration.

## About the Coleridge
The Coleridge’s mission is to improve the access, usability, and impact of data for public policy by fostering collaboration between government agencies, researchers, and other stakeholders. It aims to create a data ecosystem where government data can be more effectively used to inform evidence-based decision-making, policy development, and research.

## About the Administrative Data Research Facility
The Administrative Data Research Facility (ADRF) is a platform provided by the Coleridge that enables researchers to access and analyze administrative data from government agencies securely and efficiently. It offers a secure computing environment where researchers can work with sensitive data while ensuring privacy and confidentiality. The ADRF provides tools and infrastructure for data integration, analysis, and visualization, allowing researchers to conduct rigorous and reproducible studies using large-scale administrative datasets. By facilitating access to valuable data resources and promoting collaboration between researchers, government agencies, and other stakeholders, the ADRF supports evidence-based policymaking and advances research in fields such as public health, education, labor economics, and social policy.
...
The Coleridge PASS web-based application is the central console for managing user onboarding, monitoring ADRF usage, and consolidating necessary training. Completing the tasks in the PASS Portal is mandatory before gaining access to your project workspace.
